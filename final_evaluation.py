...
from final_agent.hybrid_agent import HybridAgent
from comparing_agents.freq_based_agents.hardhead_freq_negotiator import HardheadFreqNegotiator
from comparing_agents.time_based_agents.time_based_agent import (
...
# Student agents
STUDENT_AGENTS = {
    "HardheadFreqBidder":    HardheadFreqNegotiator,
    "ExpAspirationConceder": TimeBasedAspirationConceder,
    "ArgmaxConceder":        UniqueArgmaxTimeBasedConceder,
    "AdaptiveConceder":      AdaptiveUniqueArgmaxConceder,
    "BayesianConceder":      NaiveBayesianTimeBasedNegotiator,
}
